...
<template>
  <div class="content-interview">
    <app-card>
      ...
      <template #content>
        <app-inputext class="input mb-3" placeholder="Компания" v-model="company" />
        <app-inputext
          v-model="vacancyLink"
          class="input mb-3"
          placeholder="Описание вакансии (ссылка)"
        />
        <app-inputext v-model="hrName" class="input mb-3" placeholder="Контакт (имя)" />
        <app-inputext
        ...
        />
        <app-inputext v-model="contactPhone" class="input mb-3" placeholder="Телефон HR" />
        <app-button
